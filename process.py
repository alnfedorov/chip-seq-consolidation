...
bam = [
    ...
    BamMeta("breplica1", TARGERT, "ENCFF578CVN", paired=False),
    BamMeta("breplica2", TARGERT, "ENCFF074TRC", paired=False),

    # control
    BamMeta("control1", "control", "ENCFF151EVR", paired=False),
    BamMeta("control2", "control", "ENCFF468JNY", paired=False)
]
